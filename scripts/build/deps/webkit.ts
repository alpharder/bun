...
// embedder runs their tasks. It sits on top of aea1f010, the pin here before this change. Swap
// in the merged sha once that PR lands.
export const WEBKIT_VERSION = "autobuild-preview-pr-487-3ebdb7ef";
